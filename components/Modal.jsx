...
const Modal = ({ header, body, footer, handleClose }) => {
  ...
  return (
    <div className="flexCenter fixed inset-0 z-10 bg-overlay-black fadeIn" onClick={handleClickOutside}>
      <div ref={modalRef} className="w-2/5 md:w-11/12 minlg:2/4 dark:bg-nft-dark bg-white flex flex-col rounded-lg">
        ...
        <div className="flexCenter w-full text-center p-4">
          <h2 className="font-poppins dark:text-white text-nft-gray-1 font-bold text-xl">
            {header}
          </h2>
        </div>
